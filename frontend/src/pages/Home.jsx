    ...
    return (
        <div>
            <div className="flex justify-center mb-10">
                <div className="relative w-full max-w-md">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                        value={keyword}
            ...
            <h1 className="text-3xl font-extrabold text-center mb-12 text-gray-800">
                {keyword ? `Results for "${keyword}"` : 'Latest Collection'}
            </h1>
                        ...
                        <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                                    ...
                                    <button
                                        className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl flex items-center font-semibold transition active:scale-95"
